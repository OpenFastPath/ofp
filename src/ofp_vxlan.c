...
static void ofp_vxlan_tmo(void *arg)
{
	...
	ofp_timer_start(VXLAN_TICK, ofp_vxlan_tmo, NULL, 0);
}
...
void ofp_vxlan_init_global(void)
{
...
void ofp_vxlan_alloc_shared_memory(void)
{
...
void ofp_set_vxlan_interface_queue(void)
{
